...
|---|---|---|---|---|---|---|---|---|
| Atrial Fibrillation | 500 | Atrial Fibrillation | 72.0 | 0.0 | 61.8 | 0.0 | 49.2 | 0.0 |
| Bradycardia | 500 | Bradycardia | 3.2 | 1.8 | 2.6 | 1.4 | 2.2 | 1.2 |
...
| Supraventricular Trigeminy | 500 | Supraventricular Trigeminy | 67.4 | 0.8 | 54.8 | 0.4 | 40.6 | 0.0 |
...
| Ventricular Trigeminy | 500 | Ventricular Trigeminy | 37.8 | 0.6 | 26.8 | 0.4 | 19.6 | 0.0 |
...
|---|---|---|
| 0.5 | 29.0% (1598/5501) | **16.3%** (898/5501) |
| 0.6 | 24.9% (1368/5501) | **14.2%** (781/5501) |
| 0.7 | 20.7% (1136/5501) | **12.4%** (682/5501) |

### Suppressed classes only

| Threshold | Raw FP rate | Post-suppression FP rate |
|---|---|---|
| 0.5 | 45.1% (902/2000) | **0.8%** (16/2000) |
| 0.6 | 36.5% (730/2000) | **0.6%** (11/2000) |
| 0.7 | 27.9% (558/2000) | **0.3%** (6/2000) |
...
|---|---|---|---|
| Atrial Fibrillation | 72.0% → **0.0%** | 61.8% → **0.0%** | 49.2% → **0.0%** |
| Bradycardia | 3.2% → **1.8%** | 2.6% → **1.4%** | 2.2% → **1.2%** |
| Supraventricular Trigeminy | 67.4% → **0.8%** | 54.8% → **0.4%** | 40.6% → **0.0%** |
| Ventricular Trigeminy | 37.8% → **0.6%** | 26.8% → **0.4%** | 19.6% → **0.0%** |
